...
//    ResponseEntity<?> create(@RequestParam SaveCinemaRequest name, @RequestParam SaveCinemaRequest address,
//                             @RequestParam byte[] logo) {
//        try {
//            return new ResponseEntity<>(service.create(name,address,logo), HttpStatus.CREATED);
//        } catch (Exception e) {
//            return new ResponseEntity<>(e.getMessage(), HttpStatus.CONFLICT);
//        }
//    }
